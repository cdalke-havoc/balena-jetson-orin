...
SRC_URI += " file://tegra234-p3768-0000+p3767-0003-nv-forecr.dtb "
SRC_URI += " file://tegra234-p3768-0000+p3767-0004-nv-forecr.dtb "
SRC_URI += " file://tegra234-p3768-0000+p3767-0000-dynamic-forecr.dtbo "
...
do_install:append:jetson-orin-nano-4g-forecr() {
	install -m 0644 "${WORKDIR}/tegra234-p3768-0000+p3767-0004-nv-forecr.dtb" "${D}/boot/tegra234-p3768-0000+p3767-0004-nv.dtb"
	install -m 0644 "${WORKDIR}/tegra234-p3768-0000+p3767-0004-nv-forecr.dtb" "${D}/boot/tegra234-p3768-0000+p3767-0004-nv-forecr.dtb"
}

do_install:append:jetson-orin-nano-8g-forecr() {
	install -m 0644 "${WORKDIR}/tegra234-p3768-0000+p3767-0003-nv-forecr.dtb" "${D}/boot/tegra234-p3768-0000+p3767-0003-nv.dtb"
	install -m 0644 "${WORKDIR}/tegra234-p3768-0000+p3767-0003-nv-forecr.dtb" "${D}/boot/tegra234-p3768-0000+p3767-0003-nv-forecr.dtb"
}
...
FILES:${PN}:jetson-orin-nano-4g-forecr += " \
	/boot/tegra234-p3768-0000+p3767-0004-nv.dtb \
	/boot/tegra234-p3768-0000+p3767-0004-nv-forecr.dtb \
"

FILES:${PN}:jetson-orin-nano-8g-forecr += " \
	/boot/tegra234-p3768-0000+p3767-0003-nv.dtb \
	/boot/tegra234-p3768-0000+p3767-0003-nv-forecr.dtb \
"
